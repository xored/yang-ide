 ...
 * at the time of change of this collection (see  {@link #addHighway} and {@link #removeHighway} methods).
 * </p>
 *
 */
public interface IHighwayMatrix
{
    ...
    /**
     * Returns the identifier of the specified {@code highway}, or -1 if highways collection does not contain the element.
     *
     * @param highway - element to search for
     * 
     * @return the identifier of the specified {@code highway}, or -1 if highways collection does not contain the element.
     * 

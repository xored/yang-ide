 ...
 *   <li>{@link com.cisco.yangide.ext.model.impl.AnyxmlImpl#getRefId <em>Ref Id</em>}</li>
...
public class AnyxmlImpl extends MinimalEObjectImpl.Container implements Anyxml {
    ...
    public void setRefId(String newRefId) {
        ...
        refId = newRefId;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ANYXML__REF_ID, oldRefId, refId));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case ModelPackage.ANYXML__REF_ID:
                return getRefId();

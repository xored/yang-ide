 ...
 *   <li>{@link com.cisco.yangide.ext.model.impl.LeafListImpl#getRefId <em>Ref Id</em>}</li>
...
public class LeafListImpl extends MinimalEObjectImpl.Container implements LeafList {
    ...
    public void setRefId(String newRefId) {
        ...
        refId = newRefId;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.LEAF_LIST__REF_ID, oldRefId, refId));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case ModelPackage.LEAF_LIST__REF_ID:
                return getRefId();

 ...
 *   <li>{@link com.cisco.yangide.ext.model.impl.RpcImpl#getRefId <em>Ref Id</em>}</li>
...
public class RpcImpl extends MinimalEObjectImpl.Container implements Rpc {
    ...
    public void setRefId(String newRefId) {
        ...
        refId = newRefId;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.RPC__REF_ID, oldRefId, refId));
    }

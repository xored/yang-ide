...
/**
 * Contains factory methods that create generators of additional information 
 * for a proposal backed by an indexed element.
 * 
...
public class IndexInfoProposalHelpGenerator implements IProposalHelpGenerator {
    ...
    /**
     * @return an implementation of {@link IProposalHelpGenerator} that generates quick help
     * for YANG 'type' definition
     */
    ...
    /**
     * @return an implementation of {@link IProposalHelpGenerator} that generates quick help
     * for YANG sub-module definition
     */

...
public class YangIndenter {
    ...
    */
     ...
     * @param scanner the {@link YangHeuristicScanner} to be used for scanning
     ...
     *         should be indented, or {@link YangHeuristicScanner#NOT_FOUND}
     */
    ...
    private boolean isStringContinuation(int offset) {
        int nextNonWSCharPosition= fScanner.findNonWhitespaceBackwardInAnyPartition(offset - 1, YangHeuristicScanner.UNBOUND);
        try {
            ...
            while (true) {
                ...
                // scopes: skip them
                    ...
                    case Symbols.TokenEQUAL:
                        int stringStartingOffset= fScanner.findNonWhitespaceForwardInAnyPartition(fPosition + 1, YangHeuristicScanner.UNBOUND);
